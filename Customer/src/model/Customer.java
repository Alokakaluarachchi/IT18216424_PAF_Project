...
{ //A common method to connect to the DB
		...
		try
		{
			...
			while (rs.next())
			{
				...
				output += "<td><input name='btnUpdate' type='button' value='Update' class='btnUpdate btn btn-secondary'></td>"
						+ "<td><button class='btnRemove btn btn-danger' name='btnRemove' id ='btnRemove' value='"+ customerID +"' >Remove</button></td></tr>";
						}
	...
	public String deleteCustomer(String customerID)
	{
		...
		try
		{
			...
			String newCustomer = readCustomers(); output = "{\"status\":\"success\", \"data\": \"" + newCustomer + "\"}";
		}
		catch (Exception e)
		{
